...
#define E_NO_FREE_ENV	-5			// Attempt to create a new environment beyond the maximum allowed
...
#define E_NO_SEMAPHORE	-11				// no system semaphores available
...
#define E_NO_TABLE -21					// Table not exists for the given VA
